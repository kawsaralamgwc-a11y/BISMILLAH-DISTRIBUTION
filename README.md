...
## আলাদা আয় ও ব্যয় হিসাব

- পণ্য ক্রয় আগের মতো **ক্রয় অর্ডার / ক্রয় হিসাবেই** থাকবে।
- দোকানের অন্যান্য আয় **আয় হিসাব** মেনুতে আলাদা করে যোগ করা যাবে।
- দোকানের অন্যান্য খরচ **ব্যয় হিসাব** মেনুতে আলাদা করে যোগ করা যাবে।
- প্রতিটি আয়/ব্যয়ের সঙ্গে ক্যাশ বা ব্যাংক হিসাব নির্বাচন করা যায়; সেই অনুযায়ী ক্যাশ/ব্যাংক ব্যালেন্সও আপডেট হয়।
- রিপোর্টে ক্রয়, অন্যান্য আয়, অন্যান্য ব্যয় এবং নীট লাভ/ক্ষতি আলাদা দেখানো হয়।
